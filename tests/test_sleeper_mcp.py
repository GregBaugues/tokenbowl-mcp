...
class TestPlayerTools:
    ...
    async def test_search_player_by_name_mock(self):
        ...
        # Mock the imported function directly (it's a sync function, not async)
        with patch("sleeper_mcp.search_players_unified", new_callable=Mock) as mock_search:
    ...
    async def test_get_player_by_sleeper_id_mock(self):
        ...
        with patch("sleeper_mcp.get_player_by_id", new_callable=Mock) as mock_get_player:

...
class TestSimpleValidParams:
    ...
    def test_roster_id_validation(self):
        ...
        assert (
            sleeper_mcp.get_roster.fn.__wrapped__.__code__.co_varnames[0] == "roster_id"
        )
    ...
    def test_week_validation(self):
        ...
        assert (
            sleeper_mcp.get_league_matchups.fn.__wrapped__.__code__.co_varnames[0]
            == "week"
        )
    ...
    def test_round_validation(self):
        ...
        assert (
            "round"
            in sleeper_mcp.get_league_transactions.fn.__wrapped__.__code__.co_varnames
        )

    def test_search_name_validation(self):
        """Test name parameter validation accepts valid values."""
        assert (
            sleeper_mcp.search_players_by_name.fn.__wrapped__.__code__.co_varnames[0]
            == "name"
        )
    ...
    def test_trending_type_validation(self):
        ...
        assert (
            sleeper_mcp.get_trending_players.fn.__wrapped__.__code__.co_varnames[0]
            == "type"
        )
